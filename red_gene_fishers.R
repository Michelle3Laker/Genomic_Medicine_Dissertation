...
##rmr that odds ratio is the no. of times it's more likely that 
##the White ethnic group has a red gene and vice versa. mostly less likely for sig diff groups here
