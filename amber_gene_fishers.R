...
##rmr that odds ratio > 1 is the no. of times it's more likely that the White: British ethnic group has an amber gene and vice versa
...
##zero odds ratios are simply because there are no people without amber gene variants in these groups